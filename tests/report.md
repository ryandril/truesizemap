...
URL: http://localhost:4173/ · 2026-09-07T22:54:35.280Z
...
| 4 Pan / pinch-zoom / pole limits / endless E-W | FAIL | FAIL |
...
| 8 City flow (search Tokyo, Jakarta, drag) | FAIL | PASS |
| 9 Share link round-trip | PASS | PASS |
| 10 Theme toggle persists | PASS | PASS |
| 11 Reset after zoom + lift | FAIL | PASS |
| 12 Landscape layout (mobile) / resize | FAIL | PASS |
| 13 Accessibility: names, aria-checked, touch targets | FAIL | PASS |
...
- 'Why?' reopens: true
- first label seen: "Greenland · 8.9% of North America"; compare card appeared 1916ms after the label read "of Africa"
...
- tap Brazil @(72,458) -> labels: ["Brazil · 8.50M km²"]
...
- label before: "Brazil · 8.50M km²" @(78,458)
- label after:  "Brazil · 14× the size of Central African Rep." @(209,421)
...
### [mobile] 4 Pan / pinch-zoom / pole limits / endless E-W — FAIL
- level after deep zoom: city; distinct colours in band 110 -> 320
...
- after 2 rightward pans (660px): land fraction 45.4%, opaque 1028040/1028040
- tests/shots/mobile-04-pan-east-west-2.png
- after 10 rightward pans (3300px total): land fraction 0.0%, opaque 0/1028040; tap on the blank map lifts anything? 0 labels
...
- zoomed toggle: labels ["Egypt","Libya"] spacing 54px -> 45px (ratio 0.84); level country -> country; hash #m=e&g=EGY@29.45,26.19;LBY@18.01,26.64&l=country
...
- after lifting 4: shapes in hash=3 ["IND@79.36,22.69","AUS@134.05,-24.13","CAN@-101.91,60.32"]; visible labels=2 ["India","Canada"]; toast: {"hidden":false,"text":"Three at a time — oldest removed"}
...
- continent "Europe → Africa": OK "Europe · 33% of Africa"; cmp-b "Africa"; click 27ms
- continent "Antarctica → Africa": OK "Antarctica · 41% of Africa"; cmp-b "Africa"; click 33ms
- continent "Oceania → Europe": OK "Oceania · 87% of Europe"; cmp-b "Europe"; click 20ms
- country "Alaska → Mexico": OK "Alaska · 76% of Mexico"; cmp-b "Mexico"; click 34ms
- country "Greenland → DR Congo": OK "Greenland · 92% of Dem. Rep. Congo"; cmp-b "Dem. Rep. Congo"; click 38ms
- country "Australia → USA": OK "Australia · 82% of United States of America"; cmp-b "United States of America"; click 28ms
- country "India → Argentina": OK "India · 1.1× the size of Argentina"; cmp-b "Argentina"; click 30ms
- country "Japan → Madagascar": OK "Japan · 62% of Madagascar"; cmp-b "Madagascar"; click 17ms
- city "New York → Tokyo": OK "New York City · city · 33% of Tokyo"; cmp-b "Tokyo"; click 34ms
- city "London → Jakarta": OK "London · administrative area · 2.3× the size of Jakarta"; cmp-b "Jakarta"; click 29ms
- city "Shanghai → Singapore": OK "Shanghai · province-level · 14× the size of Singapore"; cmp-b "Singapore"; click 24ms
...
### [mobile] 8 City flow (search Tokyo, Jakarta, drag) — FAIL
- search results: [{"name":"Tokyo","tag":"city · Japan"}]
- Tokyo label: NONE; hash #m=w&g=Q1490@139.75,35.69&l=city; compare: Tokyo vs Japan; level tab now: city; land fraction in band 45% -> 45%
- #app horizontal scroll after using search: scrollLeft=21 scrollWidth=411 vs viewport 390
...
- drag Jakarta by (+90,+30)px: label gone
...
- source labels: ["India · 3.16M km²","Brazil · 14× the size of Central African Rep."]
...
### [mobile] 11 Reset after zoom + lift — FAIL
- tests/shots/mobile-11-before-reset.png
- reset visible before: true; 2.5s after reset: {"labels":0,"resetHidden":false,"hint":{"text":"Tap a country, then drag it","off":false},"clearHidden":true,"hash":"#m=w&l=country"}
- pressed reset a 2nd time: #reset hidden=true
- tests/shots/mobile-11-after-reset.png

### [mobile] 12 Landscape layout (mobile) / resize — FAIL
- portrait 390x844: header/level controls outside the viewport: [{"el":"theme","left":371,"right":411,"vw":390}]; #app {"scrollLeft":0,"scrollWidth":411,"topScrollWidth":411,"vw":390}
- after focusing the search box: #app.scrollLeft=0, h1 left edge x=12
- tests/shots/mobile-12-portrait-after-search-focus.png
- viewport 844x390: header 0-68, controls 209-390, visible map band 141px, header/controls overlap: false
- search {"top":222,"bottom":264,"left":257,"right":830,"h":42}, theme {"top":15,"bottom":55,"left":790,"right":830,"h":40}, hint {"top":78,"bottom":108,"left":318,"right":526,"h":30}; preset row scrollW 960 vs clientW 816
- tests/shots/mobile-12-landscape.png
- tap Brazil in landscape @(308,194) -> labels ["Brazil · 8.50M km²"]
- tests/shots/mobile-12-landscape-lift.png

### [mobile] 13 Accessibility: names, aria-checked, touch targets — FAIL
...
- pointer:coarse=true; targets: [{"el":"icon-btn:reset","w":40,"h":40},{"el":"chip:clear","w":116.1,"h":39.4},{"el":"seg:mercator","w":85.7,"h":39.4},{"el":"seg:equalearth","w":108.1,"h":39.4},{"el":"icon-btn:theme","w":40,"h":40},{"el":"seg:city","w":55.9,"h":39.4},{"el":"seg:country","w":78.3,"h":39.4},{"el":"seg:continent","w":93.2,"h":39.4},{"el":"chip:","w":138.2,"h":39.4},{"el":"chip:","w":174.9,"h":39.4},{"el":"chip:","w":138.2,"h":39.4},{"el":"chip:","w":152.9,"h":39.4},{"el":"chip:","w":160.2,"h":39.4},{"el":"chip:share","w":94.1,"h":39.4}]
- targets under 40px tall: 12 [{"el":"chip:clear","w":116.1,"h":39.4},{"el":"seg:mercator","w":85.7,"h":39.4},{"el":"seg:equalearth","w":108.1,"h":39.4},{"el":"seg:city","w":55.9,"h":39.4},{"el":"seg:country","w":78.3,"h":39.4},{"el":"seg:continent","w":93.2,"h":39.4},{"el":"chip:","w":138.2,"h":39.4},{"el":"chip:","w":174.9,"h":39.4},{"el":"chip:","w":138.2,"h":39.4},{"el":"chip:","w":152.9,"h":39.4},{"el":"chip:","w":160.2,"h":39.4},{"el":"chip:share","w":94.1,"h":39.4}]
- canvas aria-label: "World map. Tap a place to lift a copy, then drag it."; why dialog: {"role":"dialog","modal":"true","labelledby":"why-title"}; search accessible name: "placeholder only: Search a place…"
...
- reappeared after reload: false (localStorage seenWhy=1)
- 'Why?' reopens: true
- first label seen: "Greenland · 7.2% of Africa"; compare card appeared 397ms after the label read "of Africa"
- demo label: "Greenland · 7.2% of Africa"; compare visible: true; cmp-b: "Africa"
...
- label before: "Brazil · 8.50M km²" @(465,449)
- label after:  "Brazil · 14× the size of Central African Rep." @(699,385)
- base-map probe (80x80 px around India) changed pixels: 0/6400
- tests/shots/desktop-03-after-drag.png
- label moved: true; ratio text changed: true; hash: #m=w&g=BRA@17.00,6.00

### [desktop] 4 Pan / pinch-zoom / pole limits / endless E-W — FAIL
- level after deep zoom: city; distinct colours in band 135 -> 290
...
- after 10 rightward pans (12200px total): land fraction 0.0%, opaque 0/727040; tap on the blank map lifts anything? 0 labels
...
- continent "Greenland → Africa": OK "Greenland · 7.2% of Africa"; cmp-b "Africa"; click 67ms
- continent "Europe → Africa": OK "Europe · 33% of Africa"; cmp-b "Africa"; click 33ms
- continent "Antarctica → Africa": OK "Antarctica · 41% of Africa"; cmp-b "Africa"; click 29ms
- continent "Oceania → Europe": OK "Oceania · 87% of Europe"; cmp-b "Europe"; click 20ms
- country "Alaska → Mexico": OK "Alaska · 76% of Mexico"; cmp-b "Mexico"; click 33ms
- country "Greenland → DR Congo": OK "Greenland · 92% of Dem. Rep. Congo"; cmp-b "Dem. Rep. Congo"; click 34ms
- country "Australia → USA": OK "Australia · 82% of United States of America"; cmp-b "United States of America"; click 24ms
- country "India → Argentina": OK "India · 1.1× the size of Argentina"; cmp-b "Argentina"; click 36ms
- country "Japan → Madagascar": OK "Japan · 62% of Madagascar"; cmp-b "Madagascar"; click 22ms
- city "New York → Tokyo": OK "New York City · city · 33% of Tokyo"; cmp-b "Tokyo"; click 32ms
- city "London → Jakarta": OK "London · administrative area · 2.3× the size of Jakarta"; cmp-b "Jakarta"; click 25ms
- city "Shanghai → Singapore": OK "Shanghai · province-level · 14× the size of Singapore"; cmp-b "Singapore"; click 32ms
...
- after Jakarta: labels ["Tokyo · province · 0.61% of Japan","Jakarta · province · 0.04% of Indonesia"]; level tab: city; #reset visible: true
...
- after reload {"attr":"dark","scheme":"dark","glyph":"☀","stored":"dark","bg":"rgb(11, 13, 18)"}
- after 2nd click {"attr":"light","scheme":"light","glyph":"☾","stored":"light","bg":"rgb(242, 242, 244)"}
